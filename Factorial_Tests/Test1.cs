...
namespace Factorial_Tests
{
    ...
    public class Test1
    {
        ...
        {
            try { Logic.FactorialRecursive(-1); Assert.Fail("Исключение не было выброшено"); }
        ...
        {
            try { Logic.FactorialRecursive(21); Assert.Fail("Исключение не было выброшено"); }
            catch (System.ArgumentException) { }
        }
        ...
        {
            try { Logic.FactorialIterative(-1); Assert.Fail("Исключение не было выброшено"); }
            catch (System.ArgumentException) { }
        }
        ...
        {
            try { Logic.FactorialIterative(21); Assert.Fail("Исключение не было выброшено"); }
            catch (System.ArgumentException) { }
        }
